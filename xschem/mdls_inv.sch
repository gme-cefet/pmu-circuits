...
C {devices/lab_pin.sym} 410 -320 0 0 {name=p5 sig_type=std_logic lab=DD}
C {devices/lab_pin.sym} 410 -150 0 0 {name=p6 sig_type=std_logic lab=SS
}
C {sky130_fd_pr/pfet_01v8_lvt.sym} 330 -170 1 0 {name=M1
L=0.8
W=1
nf=1
mult=1
...
C {devices/lab_pin.sym} 410 -100 0 0 {name=p7 sig_type=std_logic lab=DD}
C {sky130_fd_pr/nfet_01v8_lvt.sym} 330 -300 3 0 {name=M2
L=0.4
W=5.5
nf=1
mult=2
...
C {devices/lab_pin.sym} 410 -360 0 0 {name=p8 sig_type=std_logic lab=SS
}
