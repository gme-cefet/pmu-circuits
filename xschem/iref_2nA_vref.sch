...
C {devices/lab_pin.sym} 80 -180 0 0 {name=p4 sig_type=std_logic lab=N1}
C {devices/lab_pin.sym} 0 -120 0 0 {name=p5 sig_type=std_logic lab=N2}
C {devices/iopin.sym} 50 -310 0 0 {name=p1 lab=DD}
C {devices/iopin.sym} 40 0 0 0 {name=p2 lab=SS}
C {devices/iopin.sym} 170 -90 0 0 {name=p3 lab=VREF}
